...
export default function Products() {
  ...
  const waLinkFor = (product: Product) =>
    `https://wa.me/905308906613?text=${encodeURIComponent(getWhatsAppMessage(product))}`;
  ...
  const productCategories = [
    {
      ...
      description: 'Hassas sıcaklık kontrolü ile laboratuvar kurutma fırınları',
      icon: '🔥',
    ...
    },
    {
      ...
      price: '$15,000',
      description: 'Kömür/biyokütle için yüksek hassasiyetli kalori tayini. Basınçlı O2, otomatik karıştırma.',
      icon: '⚡',
    ...
    },
    {
      ...
      description: 'Yüksek performanslı sterilizasyon cihazları ve otoklavlar',
      icon: '🛡️',
  ...
  useEffect(() => {
    ...
    productCategories.forEach((_: Product, index: number) => {
      const updateCount = () => {
    ...
    <section id="products" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {productCategories.map((category: Product) => (
            <div
              key={category.id}
            ...
            >
              ...
              <div className="mt-6">
                <a
                  ...
                  className="w-full bg-green-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-green-700 transition-colors flex items-center justify-center gap-2"
                >
